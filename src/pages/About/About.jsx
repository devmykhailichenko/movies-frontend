...
export default function About() {
  return (
    <Card>
      ...
      <Paragraph>
        Movie Finder is a diploma project that demonstrates the development of a modern frontend
        application with centralized state management and asynchronous API requests.
      </Paragraph>
